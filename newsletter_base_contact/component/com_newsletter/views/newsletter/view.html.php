...
class NewsletterViewNewsletter extends JView
{
	function display($tpl = null)
	{
		...
		$this->assignRef('newsurlconditions' , $pparams->get('newsletter_url_conditions') );
		$this->assignRef('newssubscription' , $pparams->get('newsletter_subscription') );
		$this->assignRef('newssubscriptionid' , $pparams->get('newsletter_subscription_id') );
